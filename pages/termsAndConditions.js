  ...
  return (
    <div className="container" style={{ paddingTop: "140px" }}>
      <div>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              "We", "Us" or "Our" in this Agreement) refers to Central Core.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Central Core, accessible from{" "}
              <a
                href="https://central-core.pl"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://central-core.pl
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>By email: office@central-core.pl</li>
        </ul>
      </div>
    </div>
  );
